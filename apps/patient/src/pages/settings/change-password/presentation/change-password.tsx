...
export const ChangePasswordScreen = (props: IChangePasswordProps) => {
	...
	return (
		<div className=" p-4 rounded-md border border-muted-foreground/10 flex-1">
			<div>
				Change Password
				<div className='text-sm font-normal'>Update you password by filling the below details.</div>
			</div>
			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onChangePasswordSubmit)}>
					...
					>
						{props.isLoading ? <Icons.spinner className="mr-2 h-4 w-4 animate-spin" /> : 'Change Password'}
					</Button>
				</form>
			</Form>
		</div>
