...
import { Button, buttonVariants, CalendarProps, Input, Popover, PopoverContent, PopoverTrigger, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '../shadcn/ui';
...
const DateTimePicker = React.forwardRef<DateTimePickerRef, DateTimePickerProps>(
  (
    ...
    // set the display date formatting
    ...
    return (
      <Popover>
        <PopoverTrigger asChild disabled={disabled} className='hover:bg-background'>
          <Button
            variant="outline"
            className={cn(
        ...
        <PopoverContent className="w-auto p-0">
          <Calendar
            ...
            {...props}
          />
          {enableTimePicker && granularity !== 'day' && (
