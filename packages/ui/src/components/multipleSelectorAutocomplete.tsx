...
export function useMultipleAutocompleteDebounce<T>(value: T, delay?: number): T {
...
const MultipleSelectorAutocomplete = React.forwardRef<MultipleSelectorAutocompleteRef, MultipleSelectorAutocompleteProps>(
    (
        {
            value,
            onChange,
        ...
        const debouncedSearchTerm = useMultipleAutocompleteDebounce(inputValue, delay || 500);
...
MultipleSelectorAutocomplete.displayName = 'MultipleSelectorAutocomplete';
export default MultipleSelectorAutocomplete;
